...
chrome_driver.get('http://www.poom.co.kr/partner/')
# 아이디/비밀번호를 입력해준다.
chrome_driver.find_element_by_id('txUserId').send_keys('p2063010307')
chrome_driver.find_element_by_xpath('//*[@id="admin_log_form"]/tbody/tr[3]/td/a').click()
